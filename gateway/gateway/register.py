...
GATEWAY_VERSION = "0.5.0"  # 0.2.0: column profiling; 0.3.0: declared keys/constraints; 0.4.0: relationship measurement; 0.4.1: profile values only for category-named columns; 0.5.0: Oracle, SAP HANA and Snowflake connectors
